...
### Using $aksVnetId, private-link will be in different RG than AKS Vnet (in MC Resource Group)
...
## From cli run below. Test to validate NW connectivity to storage account from AKS Pod
```
PrivateLinkNameSharedVNet="privatelink.blob.core.windows.net"
storageAccountName="saprivatesharedvnet"
